...
The physics simulation is based on the original 2D solver by PavelDoGreat~\cite{pavelfluid}, adding a third dimension and extra fields for temperature and buoyancy.
